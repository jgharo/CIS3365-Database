...
public class repo_garcia_2_controller implements Initializable {

    @FXML
    private TableView<repo_garcia_2> table;
    @FXML
    private TableColumn<repo_garcia_2, String> col_stu_id;
    @FXML
    private TableColumn<repo_garcia_2, String> col_stu_fname;
    @FXML
    private TableColumn<repo_garcia_2, String> col_stu_lname;
    @FXML
    private TableColumn<repo_garcia_2, String> col_stu_phone;
    @FXML
    private TableColumn<repo_garcia_2, String> col_fath_fname;
    @FXML
    private TableColumn<repo_garcia_2, String> col_fath_lname;
    @FXML
    private TableColumn<repo_garcia_2, String> col_fath_phone;
    @FXML
    private TableColumn<repo_garcia_2, String> col_fath_email;
    @FXML
    private TableColumn<repo_garcia_2, String> col_moth_fname;
    @FXML
    private TableColumn<repo_garcia_2, String> col_moth_lname;
    @FXML
    private TableColumn<repo_garcia_2, String> col_moth_phone;
    @FXML
    private TableColumn<repo_garcia_2, String> col_teach_fname;
    @FXML
    private TableColumn<repo_garcia_2, String> col_teach_lname;
    @FXML
    private TableColumn<repo_garcia_2, String> col_class_name;
    @FXML
    private TableColumn<repo_garcia_2, String> col_stu_abs;

    ObservableList<repo_garcia_2> oblist = FXCollections.observableArrayList();
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            ...
            CallableStatement stmt = con.prepareCall("{CALL repo_garcia_2()}");

            ResultSet rs = stmt.executeQuery();
            while (rs.next()) {
                oblist.add(new repo_garcia_2(rs.getString("Stu_ID"), rs.getString("Stu_FName"), rs.getString("Stu_LName"), rs.getString("Stu_Phone"),
            ...
            Logger.getLogger(repo_garcia_2.class.getName()).log(Level.SEVERE, null, ex);
        }
